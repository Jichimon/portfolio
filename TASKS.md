...
## TASK 84 — `checkBashPaths` has no shell vector for the `H-04` read boundary at all · `bugfix` · `TODO`
...
## TASK 87 — `destinationArgs`' positional fallback picks the WRONG argument when the real destination is flag-shaped · `bugfix` · `TODO`
