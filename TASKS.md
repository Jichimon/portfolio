...
## TASK 94 — Shell-level expansion (globs, variables, `cd`, unresolved redirection/substitution forms) is unexamined residual, not yet a stated one · `documentation` · `TODO`
