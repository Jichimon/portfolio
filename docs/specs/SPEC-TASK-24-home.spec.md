...
| 2026-08-26 | **Author approved `HOME-011`.** | **`approved_version`**, 1.0 → **1.1**. The spec and its implementation are now in sync. | `H-05` no longer blocks delegation against this spec. |
