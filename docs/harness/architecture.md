...
| Unfiltered CI workflow | **KEEP** | INC-08 | `.github/workflows/ci.yml` (live against a real remote since TASK 30; carries the deploy job since TASK 32) |
...
└── .github/workflows/ci.yml        no path filter; gates every trigger, deploys main
```
